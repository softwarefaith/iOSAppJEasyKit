...
#import "APNSdispatcher.h"
#import <UIKit/UIKit.h>
#import <objc/runtime.h>
@interface APNSdispatcher()
@property (nonatomic,copy)NSString *schemeHost;
@property (nonatomic,strong) NSMutableDictionary *paramDic;
@end
@implementation APNSdispatcher
...
{
    if (!self.paramDic) {
        NSString *plistPath = [[NSBundle mainBundle] pathForResource:@"APNSdispatcherRouter" ofType:@"plist"];
